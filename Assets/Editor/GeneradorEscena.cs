...
public class GeneradorEscena
{
    [MenuItem("Herramientas/Generar Escena Bonita")]
    public static void Generar()
    {
        // Crear Terreno
        TerrainData terrainData = new TerrainData();
        terrainData.heightmapResolution = 512;
        terrainData.size = new Vector3(200, 30, 200); // Más grande
        ...
        Debug.Log("🌄 Escena generada correctamente con casas, árboles y montañas.");
    }
}
